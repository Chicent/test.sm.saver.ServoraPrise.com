                ...
                if (!empty($http->response)) {
                    ...
                    if (!empty($data['data']['playurl'])) {
                        ...
                        if (!empty($data['data']['playurl']['audio_resource'])) {
                            ...
                            if (!empty($data['data']['playurl']['audio_resource'][$lastId]['backup_url'][0])) {
                        ...
                        foreach ($data['data']['playurl']['video'] as $video) {
                            if (!empty($video['video_resource']['backup_url'])) {
                                ...
                                $this->medias[] = $media;
                            } else if (!empty($video['video_resource']['url'])) {
                                $media = new Media($video['video_resource']['url'], $video['stream_info']['desc_words'], 'mp4', true, false);
                                $media->size = $video['video_resource']['size'];
                                $this->medias[] = $media;
                            }
                        }
